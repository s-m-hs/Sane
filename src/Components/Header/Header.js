  ...
  return (
    <div className="container Header">
      <div className="row Header-top  centerr">
        <div className="col-12 col-md-8 Header-rightSide centerr ">
          ...
          <div className="Header-rightSide__div-search centerc">
            <input
              className="Header-rightSide__div-search-input"
              type="text"
        ...
        <div className="col-12 col-md-4 Header-leftSide centerr">
          <div className="Header-leftSide__div centerr">
            {" "}
            <i
      ...
      <div className="row header-bottom">
                    ...
                    >
                      {mainCategory.childs &&
                        mainCategory.childs.map((item, index) => (
                          <Link
                            className="header-bottom__col__ul__ul__ul__link2"
                            to={"category"}
                          >
        ...
        <div className="header-bottom__col-logo ">
          <Link to="/">
            <img
              className="sphere3"
